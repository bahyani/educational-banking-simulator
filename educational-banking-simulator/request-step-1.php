            ...
            <div class="container-fruid">
                <div class="main-content">
                    ...
                    <div class="choose-recipient">
                        ...
                        <p class="recipients-item">0 Beneficiaries </p>
                    </div>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item" role="presentation" id="tab-internal">
...
<script>
        ...
        if(user== "" || user.length != 9){
            ...
            $.post('ajax', {
                ...
                if(data.err== 0){
                    $("#add_internal_fname").val('');
                    $("#add_internal_lname").val('');
                    $("#add_internal_user").val('');
                    $("#add_internal_pass").val('');
    ...
    $(".active_contact").click(function(){
        ...
        $('.active_contact').each(function(ids, el){
            if($(this).data('id')== contact_id){
                $(this).text("✔️ Chosen");
            }else{
                $(this).text("Choose");
            }
