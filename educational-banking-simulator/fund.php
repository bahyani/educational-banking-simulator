            ...
            <div class="container-fruid">
                <div class="main-content">
                    <div class="head-area d-flex align-items-center justify-content-between">
                        <h4>Select Method To Fund Account </h4>
                        
                    </div>
                    <div class="row pb-120">
                        <div class="col-lg-3 col-md-5">
                            <a href="fund-crypto-step-1.php" class="single-item click" data-id="crypto">
                                <div class="icon-area">
...
<script src="assets/js/jquery.min.js"></script>
    ...
    $(".click").click(function(){
        ...
        if(id== "crypto"){
            setTimeout(function(){
                window.location.href="https://"+site_domain+"/account/fund-crypto-step-1.php"
            }, 4000)
        }else{
            setTimeout(function(){
                loadOff();
