...
if($pmethod =='btc'){
    $currency = 'Bitcoin';
    $flag = "url('assets/images/icon/flag-btc.png')";

}
else if($pmethod =='eth'){
    $currency = 'Ethereum';
    $flag = "url('assets/images/icon/ethereum.png')";

}
else{
    $currency = 'usdt';
    $flag = "url('assets/images/icon/tether.png')";
}
...
<head>
    ...
    .dashboard-section.crypto
      ...
      .nice-select
      .current::before {
      background-image: <?php echo $flag; ?> !important;
    }
                ...
                <div class="main-content">
                    ...
                    <div class="row pb-120">
                        <div class="col-lg-3 col-md-4">
                            <div class="left-area">
                                <ul>
                                    <li><a href="send-fund-crypto-step-1.php" class="single-link active">Select Crypto</a></li>
                        ...
                        <div class="exchange-content">
                            <div class="send-banance">
                                ...
                                <div class="input-area">
                                    <input id="from_amt" class="xxlr" placeholder="100.00" type="number">
                                    <select>
                                        <option value="1">USD</option>
                                    </select>
                                </div>
                                <p class="mred">Available Balance<b> <?php echo $currency_symbol. " ". number_format($deposit, 2);?> <span id="subtract"></span></b></p>
                            ...
                            <div class="send-banance recipient">
                                ...
                                <div class="input-area">
                                    ...
                                    <input id="to_amt" readonly class="xxlr" placeholder="<?php echo number_format(100/$cryptoPrice,6)?>" type="number">
                                ...
                                <p>Current rate: <b id="rate_show">1 <?php echo $currency; ?> = <?php echo number_format($cryptoPrice,2);?> USD</b></p>
                            </div>
                            
                            <div class="send-banance">
                                <span class="mdr"><?php echo $currency. ' wallet address'; ?></span>
                                <div class="input-area walAddress">
                                    <input id="to_wal" class="xxlr" placeholder="" type="text">
                        ...
                        <div class="footer-area mt-40">
                                <a href="send-fund-crypto-step-1.php">Previous Step</a>
...
const searchParams = new URLSearchParams(window.location.search);
    ...
    $("#next").click(function(){
        ...
        if(amt== "" || amt == 0){
            ...
            notify('warning', 'Maximum first withdrawal amount is £100');
        }
        
        else if(wal==""){
             notify('warning', 'Wallet address is missing');
             $('.walAddress').css('border', '1px solid #ed6581');
              $('.walAddress').css('opacity', '0.5');
        }
        
        else{
            loadOn();
            window.location.href="send-fund-crypto-step-3.php?amount="+amt+"&method="+method+"&wallet="+wal
        }
    })
