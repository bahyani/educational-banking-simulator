                                                         ...
                                                         <li>
                                                            <a href="javascript:void(0)" class="d-flex">
                                                                ...
                                                                <div class="text-area">
                                                                    ...
                                                                    <p class="mdr time-area">28 mins ago</p>
                                                                </div>
                                                            </a></li>
                                                         ...
                                                         <li>
                                                            <a href="javascript:void(0)" class="d-flex">
                                                                ...
                                                                <div class="text-area">
                                                                    ...
                                                                    <p class="mdr time-area">26 mins ago</p>
                                                                </div>
                                                            </a></li>
                        ...
                        <div class="col-xxl-3 col-xl-4 col-md-6">
                            <div class="owner-details">
                                <div class="profile-area">
                                    <div class="profile-img">
                                                                                 <img src="assets/images/uploads/avatar/user.png" alt="image" width="120em">
                                    </div>
                                    <div class="name-area">
                                        <h6>Egan Bernard</h6>
                                ...
                                <div class="owner-info">
                                    <ul>
                                        <li>
                                            <p>Account No:</p>
                                            <span class="mdr">110526830</span>
                                        </li>
                                        <li>
                                            <p>Joined:</p>
                                            <span class="mdr">Jun 13 2023</span>
                                        </li>
                                                                                <li>
                                            <p>Confirm Status:</p>
                                            <span class="mdr">70%</span>
                                        </li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="tab-pane fade show active" id="account" role="tabpanel"
                                        ...
                                        <div class="upload-avatar">
                                            <div class="avatar-left d-flex align-items-center">
                                                <div class="profile-img">
                                                                                                        <img class="avatar" src="assets/images/uploads/avatar/user.png" alt="image" width="80em">
                                                </div>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-md-6">
                                                    <div class="single-input">
                                                        ...
                                                        <input type="text" id="fname" placeholder="Alfred" value="Bernard">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="single-input">
                                                        <label for="lName">Last Name</label>
                                                        <input type="text" id="lname" placeholder="Davis" value="Egan">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="single-input">
                                                        ...
                                                        <div class="row input-status d-flex align-items-center">
                                                            <div class="col-6">
                                                                <input type="email" readonly value="bernardegan012@gmail.com">
                                                            </div>
                                                            <div class="col-6">
                                                                <span class="confirm">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="single-input">
                                                        ...
                                                        <div class="row input-status d-flex align-items-center">
                                                            <div class="col-6">
                                                                <input type="tel" id="phone" value="+1826739476393" placeholder="(316) 555-0116">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="single-input">
                                                        ...
                                                        <input type="text" id="addr" placeholder="2972 Westheimer Rd. Santa Ana, Illinois 85486" value="">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                        ...
                                        <div class="change-pass mb-40">
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <p>You can set a security question, required upon each login to this account.</p>
                                                    <p>Adding a new security question automatically replaces the old one.</p>
                                                    <!--<a href="../forgot-password">Forgot password?</a>-->
                                                </div>
                                                <div class="col-sm-6">
                                                    <form action="#">
                                                        <div class="row justify-content-center">
                                                            <div class="col-md-12">
                                                                <div class="single-input">
                                                                    ...
                                                                    <input type="text" id="sq" placeholder="New question" value="">
                                                                </div>
                                                            </div>
                                                            <div class="col-md-12">
                                                                <div class="single-input">
...
<script>
    ...
    $("#confirmm").click(function(){
        ...
        if(c1== "" || c2== "" || c3== "" || c4==""){
            ...
            notify('warning', 'Enter security question and answer')
        }else{
            loadOn();
            $.post('ajax', {
                edit_acct: "set",
