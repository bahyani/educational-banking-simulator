...
$swift0 = $_POST['swift0'];
$routing_number0 = $_POST['routing_number0'];
$account_type0= $_POST['account_type0'];
$add_bank_namee0= $_POST['add_bank_namee0'];
...
$name = 'Internet Banking Online Transfer initiated by '.$first.' '.$last;
    ...
    if($transfer_type == 'ERROR_STOP'){
        ...
        echo'
                ...
                $pre_sql="insert into tranz(tran,name,date,type,cid,account,bname,baccount) values ('$rand','$name','$date','Debit','$cid','$account','$add_bank_namee0','$modeType')";
