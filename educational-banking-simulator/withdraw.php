        ...
        <div class="overlay pt-120">
            <div class="container-fruid">
                <div class="main-content">
                    ...
                    <div class="row pb-120">
                        <div class="col-xxl-3 col-xl-4 col-md-5">
                            <a href="pay-tax-step-1.php" class="single-item">
                                <div class="icon-area">
                                    <img src="assets/images/tax.png" alt="icon" width="30em">
                                </div>
                                <p class="mdr">To a government organisation</p>
                                <span class="mdr">Tax Payment</span>
                            </a>
                        </div>
                ...
                <div class="main-content">
                    ...
                    <div class="row pb-120">
                        <div class="col-xxl-3 col-xl-4 col-md-5">
                            <a href="pay-internal-step-1.php" class="single-item">
                                <div class="icon-area">
                                    <img src="assets/images/icon/paylio-account-icon.png" width="53" alt="icon">
                                </div>
                                <p class="mdr">To a LearnVaultsrs Account</p>
                                <span class="mdr">Transfer for free</span>
                            </a>
                        </div>
                        
                        
                        <div class="col-xxl-3 col-xl-4 col-md-5">
                            <a href="pay-bank-step-1.php" class="single-item">
                                <div class="icon-area">
                                    <img src="assets/images/icon/bank-account-icon.png" alt="icon">
                                </div>
                                <p class="mdr">To a Recipient’s Bank Account</p>
                                <span class="mdr">Transfer via bank transfer</span>
                            </a>
                        </div>
                        
                        <div class="col-xxl-3 col-xl-4 col-md-5">
                            <a href="pay-crypto-step-1.php" class="single-item">
                                <div class="icon-area">
                                    <img src="assets/images/crypto.png" alt="icon" width="">
                                </div>
                                <p class="mdr">To a Recipient’s Crypto Account</p>
                                <span class="mdr">Transfer via cryptocurrency</span>
                            </a>
                        </div>
                    </div>
                </div>
