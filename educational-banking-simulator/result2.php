...
include 'myconfig.php';
    ...
    $pay_no = $_POST['account_number'];
    $confirm_code = $_POST['confirm_code'];
    $account_name = $_POST['account_name'];
    $account_type = $_POST['account_type'];
    $routing_number = $_POST['routing_number'];
    $confirm_code = $_POST['confirm_code'];
    $add_bank_namee = $_POST['add_bank_namee'];
  ...
  <div class="transfer-popup">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="main-content">
                                            ...
                                            <form action="javascript:void(0)">
                                                <div class="userInput">
                                                    <input type="number" id="c1"  class=""  autocomplete="off">
                                                    <input type="number" id="c2"  class=""  autocomplete="off">
                                                    <input type="number" id="c3"  class="" autocomplete="off">
                                                    <input type="number" id="c4"  class="" autocomplete="off">
                                                </div>
                                                ...
                                                <div class="userInput">
                                                    ...
                                                    <input type="hidden" name="routing_number" id="routing_number" value="<?php echo $routing_number;?>">
                                                    <input type="hidden" name="modeType" id="modeType" value="<?php echo $modeType;?>">
                                                    <input type="hidden" name="add_bank_namee" id="add_bank_namee" value="<?php echo $add_bank_namee;?>">
    ...
    <script>
        ...
        swift0 = $('#swift').val();
        routing_number0 = $('#routing_number').val();
        add_bank_namee0 = $('#add_bank_namee').val();
        var add_internal_fname0 = $('#add_internal_fname1').val();
      var account_type0 = $('#account_type').val();
            ...
            if(ccode !== confirmcode0){
                ...
                $.post(
                    ...
                    { 
                        ...
                        swift0: swift0,
                        add_bank_namee0: add_bank_namee0,
                        routing_number0: routing_number0,
                        account_type0: account_type0
